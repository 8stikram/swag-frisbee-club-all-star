...
sec('effet', "5 · Ce que la zone fait à l'adversaire",
    ...
    [
     ("RALENTI 25 %, DRAIN 7,5 %/s — RETENU", "Le ralenti au milieu de la fourchette, et le drain TRÈS au-dessus : le cahier des charges disait 1,5 à 2 %/s, on est à 7,5. Sur sept secondes ça lui prend 52,5 % de sa barre s'il reste dedans du début à la fin — plus de la moitié d'un ultime. C'est assez pour que la traverser soit une vraie décision, pas assez pour que ce soit un interdit : on peut choisir d'y aller parce que le disque est dedans, et le payer. C'est le premier chiffre à rebaisser si elle paraît trop forte.", dict(ef={'slow': .25, 'drain': 7.5})),
