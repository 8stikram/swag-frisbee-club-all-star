...
sec('effet', "5 · Ce que la zone fait à l'adversaire",
    ...
    [
     ("RALENTI 25 %, DRAIN 12 %/s — RETENU", "Le ralenti au milieu de la fourchette, et le drain TRÈS au-dessus : le cahier des charges disait 1,5 à 2 %/s, on est à 12. Sur sept secondes ça lui prend 84 % de sa barre s'il reste dedans du début à la fin — quatre cinquièmes d'un ultime. À ce prix la zone n'est plus une gêne ni même une punition, c'est un INTERDIT : on ne la traverse pas, on en fait le tour. C'est le premier chiffre à rebaisser si elle paraît trop forte.", dict(ef={'slow': .25, 'drain': 12})),
