...
//
// La queue, elle, ne bouge PAS en course : elle se tend au dash et fouette au
// tir. C'est le réglage qui coûte le moins cher — deux poses de course
// suffisent, comme pour le reste du roster — tout en mettant le mouvement là
// où on le regarde.
const ANATOMIE = [
  ...
  ['LA QUEUE', '#7ef0c8', 17, 19, 0, 4, 'fixe en course ; elle se tend au dash et fouette au tir'],
  ['les DEUX jambes et leurs griffes', '#ff8c1a', 17, 19, 5, 15, 'elles alternent']
];
